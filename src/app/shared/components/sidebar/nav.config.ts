...
export const NAV_ITEMS: readonly NavItem[] = [
  ...
  },
  {
    ...
    children: [
      {
        id: 'stores-super-list',
        labelKey: 'nav.storesActive',
        route: '/stores',
        svgPath: '<path d="M3 9l2-5h14l2 5"></path>',
      },
      {
        id: 'stores-super-commissions',
        labelKey: 'nav.storesPercentage',
        route: '/store-commissions',
        svgPath: '<circle cx="12" cy="12" r="10"></circle><path d="M12 3v18"></path><path d="M8 14c1 1.5 2.3 2 4 2 2.2 0 4-1 4-3 0-4-8-1.5-8-5 0-2 1.8-3 4-3 1.5 0 2.8.5 3.7 1.5"></path>',
      },
    ],
  },
  {
